...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Top Navbar — padding-top accounts for iOS notch/status bar in standalone PWA mode */}
      <nav style={{ backgroundColor: 'rgb(13, 27, 42)', paddingTop: 'env(safe-area-inset-top, 0px)' }} className="text-white shadow-lg relative z-50">
